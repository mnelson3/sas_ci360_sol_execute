...
This repository holds a historical Python client for SAS Customer Intelligence 360 Marketing Execution APIs, retained as a reference and no longer under active development. Only the code currently deployed on each environment branch is supported — there is no long-term support for older commits.
...
- GitHub's [private vulnerability reporting](https://github.com/mnelson3/sas_ci360_sol_execute/security/advisories/new) (enabled on this repo), or
